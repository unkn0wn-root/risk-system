...
// handles authentication and email formatting for the SendGrid service.
...
// requires an API key, sender email address, and sender name.
...
// validates the API key and handles error responses from the SendGrid service.
