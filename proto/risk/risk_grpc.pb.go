...
func (c *riskAdminServiceClient) CreateRiskRule(ctx context.Context, in *CreateRiskRuleRequest, opts ...grpc.CallOption) (*CreateRiskRuleResponse, error) {
	...
	err := c.cc.Invoke(ctx, RiskAdminService_CreateRiskRule_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *riskAdminServiceClient) UpdateRiskRule(ctx context.Context, in *UpdateRiskRuleRequest, opts ...grpc.CallOption) (*UpdateRiskRuleResponse, error) {
	...
	err := c.cc.Invoke(ctx, RiskAdminService_UpdateRiskRule_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *riskAdminServiceClient) DeleteRiskRule(ctx context.Context, in *DeleteRiskRuleRequest, opts ...grpc.CallOption) (*DeleteRiskRuleResponse, error) {
	...
	err := c.cc.Invoke(ctx, RiskAdminService_DeleteRiskRule_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *riskAdminServiceClient) ListRiskRules(ctx context.Context, in *ListRiskRulesRequest, opts ...grpc.CallOption) (*ListRiskRulesResponse, error) {
	...
	err := c.cc.Invoke(ctx, RiskAdminService_ListRiskRules_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *riskAdminServiceClient) GetRiskStats(ctx context.Context, in *GetRiskStatsRequest, opts ...grpc.CallOption) (*GetRiskStatsResponse, error) {
	...
	err := c.cc.Invoke(ctx, RiskAdminService_GetRiskStats_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedRiskAdminServiceServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedRiskAdminServiceServer) testEmbeddedByValue()                          {}
...
func RegisterRiskAdminServiceServer(s grpc.ServiceRegistrar, srv RiskAdminServiceServer) {
	// If the following call pancis, it indicates UnimplementedRiskAdminServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
